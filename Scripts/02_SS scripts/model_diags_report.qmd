...
file.copy(from = file.path(getwd(), "data_echo.ss_new"), 
  to = file.path(profile.dirs, "data_echo.ss_new"), overwrite = T)
...
SSplotProfile(profilesummary, # summary object
  profile.string = substr(profile.str, start = 1, stop = 5), # substring of profile parameter
  exact = F,
...
if(dir.exists(file.path(getwd(), "jitter"))){
  ...
  jitter.dir <- file.path(getwd(), "jitter")
  file.copy(from = file.path(getwd(), "data_echo.ss_new"), 
    to = file.path(jitter.dir, "data_echo.ss_new"), overwrite = T)
